...
const About: React.FC = () => {
  const hintList = [
    "VEIL PLUS 代表了一种新的范式转变——从“生态锁定用户” 到 “用户选择生态”。",
    "在传统 Web3 中，用户在不同生态间切换时，其历史、信誉、关系均被重置。",
  ...
  return (
    <div className="aboutPage">
      <LeftBackHeader title="关于我们"></LeftBackHeader>
      <div className="contentPage">
        <div className="title">VEIL PLUS</div>
        <div className="hintTxt">让行为成为资产，身份自由流动</div>
        <div className="hintBoxTxt">构建可移植的全链上身份协议</div>
